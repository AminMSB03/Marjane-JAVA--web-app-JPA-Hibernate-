                ...
                <div class="grid grid-cols-3 gap-8 items-center">
                    <div class="col-span-2">
                        <nav class="flex space-x-4">
                            ...
                            <a href="#" class="text-indigo-100 text-sm font-medium rounded-md bg-white bg-opacity-0 px-3 py-2 hover:bg-opacity-10"> Statistics</a>
                        </nav>
                    </div>
                    <div>
                ...
                <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y divide-gray-200">
                    <div class="pt-3 pb-2">
                        ...
                        <div class="mt-3 px-2 space-y-1">
                            ...
                            <a href="#" class="block rounded-md px-3 py-2 text-base text-gray-900 font-medium hover:bg-gray-100 hover:text-gray-800">Promos</a>
                        </div>
                    </div>
                    <div class="pt-4 pb-2" >
                                        ...
                                        <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                                <table class="min-w-full divide-y divide-gray-200">
                                                    ...
                                                    <tr class="bg-white">
                                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><c:out value="${admin.id}"/></td>
                                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><c:out value="${admin.email}"/></td>
                                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><c:out value="${admin.center.ville}"/></td>
                    ...
                    <section aria-labelledby="section-2-title">
                        ...
                        <div class="rounded-lg bg-white overflow-hidden shadow">
                            <div class="p-6">
                                ...
                                <div>
                                    <label for="location" class="block text-sm mt-5 font-medium text-gray-700">Center</label>
                                    <select id="location" name="center" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-2 border-blue-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                                        <c:forEach items="${centers}" var="center">
                                        <option value="${center.id}"><c:out value="${center.ville}"/></option>
                                        </c:forEach>
                                    </select>
                                </div>
                                <input type="submit"
                                        class="inline-flex items-center px-7 m-auto mt-3 py-2 border border-transparent text-base font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" value="Add Admin"/>
                                </form>
                            </div>
                        </div>
                    </section>
