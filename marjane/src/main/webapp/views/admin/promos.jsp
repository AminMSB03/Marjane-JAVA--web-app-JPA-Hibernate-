            ...
            <div class="grid grid-cols-1 gap-4 items-start lg:grid-cols-3 lg:gap-8">
                                                ...
                                                <table class="min-w-full divide-y divide-gray-200">
                                                    ...
                                                    <c:forEach items="${promotions}" var="promotion">
                                                        <tr class="bg-white">
                                                            ...
                                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><c:out value="${promotion.category.name}"/></td>
                ...
                <div class="grid grid-cols-1 gap-4">
                    <section aria-labelledby="section-2-title">
                        ...
                        <div class="rounded-lg bg-white overflow-hidden shadow">
                            <div class="p-6">
                                <h1 class="mb-10">Add Promotion </h1>
                                <form action="promos" method="post">

                                    <h1 class="block text-sm mt-5 mb-2 font-medium text-gray-500">Set the period of the promotion : </h1>
                                    <div  class="flex items-center">
                                        <input class="mb-3 block w-full appearance-none rounded border border-blue-900 py-3 px-4 leading-tight text-gray-700 focus:border-gray-500 focus:bg-white focus:outline-none" name="start"  type="date" />
                                        <span class="mx-4 text-gray-500">to</span>
                                        <input class="mb-3 block w-full appearance-none rounded border border-blue-900 py-3 px-4 leading-tight text-gray-700 focus:border-gray-500 focus:bg-white focus:outline-none" name="end"  type="date" />
                                    </div>
                                    <div>
                                        <label for="price" class="block text-sm font-medium text-gray-700">Promo</label>
                                        <div class="mt-1 relative rounded-md shadow-sm" >
                                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                                <span class="text-gray-500 sm:text-sm"> % </span>
                                            </div>
                                            <input type="number" name="promo" id="price" class="focus:ring-blue-900 border-2 p-3 focus:border-blue-900 block w-full pl-7  sm:text-sm border-blue-900 rounded-md" min="0" max="50" placeholder="0.00" aria-describedby="price-currency">
                                        </div>
                                        <span class="text-red-700 mt-2 mb-2 text-xs	" id="promoRoles"></span>
                                    </div>
                                    <div>
                                        <label for="location" class="block text-sm mt-5 font-medium text-gray-500">Category : </label>
                                        <select id="location" name="category" class="mt-1 block text-gray-500 w-full pl-3 pr-10 py-2 text-base border-2 border-blue-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                                    ...
                                    <input type="submit"
                                           class="inline-flex items-center px-7 m-auto mt-5  py-2 border border-transparent text-base font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" value="Add Promotion"/>
                                </form>
                            </div>
                        </div>
                    </section>
...
<script>
    let promoIntput = document.getElementById("price")
    let promoSpan = document.getElementById("promoRoles")


    promoIntput.addEventListener("keyup",()=>{
        promoSpan.innerHTML=""
        if(promoIntput.value>50){
            promoSpan.innerHTML="the percentage of the promotion must not exceed 50%."
        }
    })
